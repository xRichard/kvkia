...
$dest_x = $width - $watermarksize[0] - 0;
$dest_y = $height - $watermarksize[1] - -1;
...
imagecopy($this->parentInstance->getOldImage(), $watermark, $dest_x, $dest_y, 0, 1, $watermarksize[0], $watermarksize[1]);
...
$pt->registerPlugin('GdWatermarkLib','gd');s
?>
